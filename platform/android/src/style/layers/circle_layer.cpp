...
namespace android {
    ...
    jni::Array<jni::jlong> CircleLayer::getCircleTranslateAnchorTransition(jni::JNIEnv& env) {
        using namespace mbgl::android::conversion;

        mbgl::style::TransitionOptions options = layer.as<mbgl::style::CircleLayer>()->CircleLayer::getCircleTranslateAnchorTransition();
        jlong durations[2];
        durations[0] = options.duration.value_or(mbgl::Duration::zero()).count();
        durations[1] = options.duration.value_or(mbgl::Duration::zero()).count();
        auto output = jni::Array<jni::jlong>::New(env, 2);
    ...
    void CircleLayer::setCircleTranslateAnchorTransition(jni::JNIEnv& env, jlong duration, jlong delay) {
        (void) env;
        mbgl::style::TransitionOptions options = {mbgl::Duration(duration), mbgl::Duration(delay)};
        layer.as<mbgl::style::CircleLayer>()->CircleLayer::setCircleTranslateAnchorTransition(options);
    }
    ...
    jni::Array<jni::jlong> CircleLayer::getCirclePitchScaleTransition(jni::JNIEnv& env) {
        using namespace mbgl::android::conversion;

        mbgl::style::TransitionOptions options = layer.as<mbgl::style::CircleLayer>()->CircleLayer::getCirclePitchScaleTransition();
        jlong durations[2];
        durations[0] = options.duration.value_or(mbgl::Duration::zero()).count();
        durations[1] = options.duration.value_or(mbgl::Duration::zero()).count();
        auto output = jni::Array<jni::jlong>::New(env, 2);
    ...
    void CircleLayer::setCirclePitchScaleTransition(jni::JNIEnv& env, jlong duration, jlong delay) {
        (void) env;
        mbgl::style::TransitionOptions options = {mbgl::Duration(duration), mbgl::Duration(delay)};
        layer.as<mbgl::style::CircleLayer>()->CircleLayer::setCirclePitchScaleTransition(options);
    }
    ...
    void CircleLayer::registerNative(jni::JNIEnv& env) {
        ...
        jni::RegisterNativePeer<CircleLayer>(
            ...
            METHOD(&CircleLayer::getCircleTranslateAnchorTransition, "nativeGetCircleTranslateAnchorTransition"),

            METHOD(&CircleLayer::setCircleTranslateAnchorTransition, "nativeSetCircleTranslateAnchorTransition"),

            METHOD(&CircleLayer::getCircleTranslateAnchor, "nativeGetCircleTranslateAnchor"),

            METHOD(&CircleLayer::getCirclePitchScaleTransition, "nativeGetCirclePitchScaleTransition"),

            METHOD(&CircleLayer::setCirclePitchScaleTransition, "nativeSetCirclePitchScaleTransition"),
