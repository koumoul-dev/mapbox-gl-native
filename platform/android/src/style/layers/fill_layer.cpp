...
namespace android {
    ...
    jni::Array<jni::jlong> FillLayer::getFillAntialiasTransition(jni::JNIEnv& env) {
        using namespace mbgl::android::conversion;

        mbgl::style::TransitionOptions options = layer.as<mbgl::style::FillLayer>()->FillLayer::getFillAntialiasTransition();
        jlong durations[2];
    ...
    void FillLayer::setFillAntialiasTransition(jni::JNIEnv& env, jlong duration, jlong delay) {
        (void) env;
        mbgl::style::TransitionOptions options = {mbgl::Duration(duration), mbgl::Duration(delay)};
        layer.as<mbgl::style::FillLayer>()->FillLayer::setFillAntialiasTransition(options);
    }
    ...
    jni::Array<jni::jlong> FillLayer::getFillTranslateAnchorTransition(jni::JNIEnv& env) {
        using namespace mbgl::android::conversion;

        mbgl::style::TransitionOptions options = layer.as<mbgl::style::FillLayer>()->FillLayer::getFillTranslateAnchorTransition();
        jlong durations[2];
        durations[0] = options.duration.value_or(mbgl::Duration::zero()).count();
        durations[1] = options.duration.value_or(mbgl::Duration::zero()).count();
        auto output = jni::Array<jni::jlong>::New(env, 2);
    ...
    void FillLayer::setFillTranslateAnchorTransition(jni::JNIEnv& env, jlong duration, jlong delay) {
        (void) env;
        mbgl::style::TransitionOptions options = {mbgl::Duration(duration), mbgl::Duration(delay)};
        layer.as<mbgl::style::FillLayer>()->FillLayer::setFillTranslateAnchorTransition(options);
    }
    ...
    void FillLayer::registerNative(jni::JNIEnv& env) {
        ...
        jni::RegisterNativePeer<FillLayer>(
            ...
            METHOD(&FillLayer::getFillAntialiasTransition, "nativeGetFillAntialiasTransition"),

            METHOD(&FillLayer::setFillAntialiasTransition, "nativeSetFillAntialiasTransition"),
            ...
            METHOD(&FillLayer::getFillTranslateAnchorTransition, "nativeGetFillTranslateAnchorTransition"),

            METHOD(&FillLayer::setFillTranslateAnchorTransition, "nativeSetFillTranslateAnchorTransition"),
