...
public class BackgroundLayerTest extends BaseStyleTest {
  ...
  @Test
  public void testBackgroundColorTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getBackgroundColorTransition(), options);
  }
  ...
  @Test
  public void testBackgroundPatternTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getBackgroundPatternTransition(), options);
  }
  ...
  @Test
  public void testBackgroundOpacityTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getBackgroundOpacityTransition(), options);
  }
