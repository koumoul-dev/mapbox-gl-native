...
public class RasterLayerTest extends BaseStyleTest {
  ...
  @Test
  public void testRasterOpacityTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getRasterOpacityTransition(), options);
  }
  ...
  @Test
  public void testRasterHueRotateTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getRasterHueRotateTransition(), options);
  }
  ...
  @Test
  public void testRasterBrightnessMinTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getRasterBrightnessMinTransition(), options);
  }
  ...
  @Test
  public void testRasterBrightnessMaxTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getRasterBrightnessMaxTransition(), options);
  }
  ...
  @Test
  public void testRasterSaturationTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getRasterSaturationTransition(), options);
  }
  ...
  @Test
  public void testRasterContrastTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getRasterContrastTransition(), options);
  }
  ...
  @Test
  public void testRasterFadeDurationTransitionOptions() {
    checkViewIsDisplayed(R.id.mapView);
    ...
    assertEquals((TransitionOptions) layer.getRasterFadeDurationTransition(), options);
  }
